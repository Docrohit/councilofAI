...
| Agent Skill                      | Instruction package such as `SKILL.md`                        | Native project loading in candidate source; hosted/global management pending |
...
| LSP                              | Language Server Protocol for code intelligence                | Native read-only integration in candidate source; hosted support pending     |
